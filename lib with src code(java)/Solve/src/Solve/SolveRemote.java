...
/**
 * The <code>SolveRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  F:\\zzzzzzzzzz\\eqSolve.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>SolveRemote</code> 
 ...
 * generate RMI server proxy objects for instances of Solve.Solve.
 */
public interface SolveRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>eqSolve</code> M-function 
     ...
     */
    public Object[] eqSolve(int nargout, Object... rhs) throws RemoteException;
