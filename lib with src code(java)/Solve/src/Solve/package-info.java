 ...
 * <li><code>Solve</code> package will only work with the javabuilder.jar file included with MCR version 7.17.</li>
 * </ul>
 * </p> 
 ...
 * of <code>Solve</code> package, can take instances of these concrete classes as 
